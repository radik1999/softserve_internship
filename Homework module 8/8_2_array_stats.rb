...
def Stats.most_frequent(str)
  ...
  res = str[0]
  str.each_char { |s|
    if max_number < str.count(s)
      max_number = str.count(s)
      res = s
    end
  }
  "У заданому рядку найчастіше зустрічаються символ '#{res}', а саме #{max_number} разів."
end
...
st = "hello world hohoh"

p Stats.char_stats st